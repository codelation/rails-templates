class Documentation
  def self.readme(app_name, install_blocky, install_blogelator, install_devise)
    return <<-README
# #{app_name.titleize}
...
- [Awesome Print](https://github.com/michaeldv/awesome_print)#{install_blocky ? "\n- [Blocky](https://github.com/codelation/blocky)" : ""}#{install_blogelator ? "\n- [Blogelator](https://github.com/codelation/blogelator)" : ""}#{install_devise ? "\n- [CanCan](https://github.com/ryanb/cancan)" : ""}
